System.register(['./HTTP', './sijs'], function(exports_1) {
    var HTTP_1, sijs_1;
    ...
    return {
        ...
        execute: function() {
            ...
            PMDLoader = (function () {
                function PMDLoader(url) {
                    this.url = url;
                }
                PMDLoader.load = function (url) {
                    return new Promise(function (resolve) {
                        HTTP_1.GET(url, null, 'arraybuffer').then(function (result) {
                            var loader = new PMDLoader(url);
                            loader.parse(result);
                            resolve(loader);
                        });
                    });
